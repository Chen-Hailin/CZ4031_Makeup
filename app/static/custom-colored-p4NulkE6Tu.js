...
newqepNode_1 = {
						...
						HTMLid: 'newqep_id_1',
						text: {
							name: "Node Type: Merge Join",
							Cost: "Cost: 3.6e+04",
							Cost_Percentage: "Cost Percentage: 6%",
							Tables: "",
							Join: "Join: (publications.pub_id = authorpublication.pub_id)",
							Output: "",
							highest_cost: ""
						}
					},
newqepNode_2 = {
						...
						text: {
							...
							Cost: "Cost: 5.6e+04",
							Cost_Percentage: "Cost Percentage: 10%",
...
newqepNode_3 = {
						...
						HTMLid: 'newqep_id_3',
						text: {
							name: "Node Type: Materialize",
							Cost: "Cost: 7.7e+03",
							Cost_Percentage: "Cost Percentage: 1%",
							Tables: "",
							Join: "",
							Output: "",
							highest_cost: ""
...
newqepNode_4 = {
						...
						text: {
							name: "Node Type: Sort",
							Cost: "Cost: 4.2e+05",
							Cost_Percentage: "Cost Percentage: 75%",
							Tables: "",
							Join: "",
							Output: "",
...
newqepNode_5 = {
						...
						text: {
							...
							Cost: "Cost: 4.4e+04",
							Cost_Percentage: "Cost Percentage: 8%",
...
newqepchart_config = [newqepconfig, newqepNode_1, newqepNode_2, newqepNode_3, newqepNode_4, newqepNode_5];
var oldqepconfig = {
		container: "#oldqep",
